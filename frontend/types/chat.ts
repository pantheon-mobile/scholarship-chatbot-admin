...
export type ChatMessage = { contextReference?: string | null; id: string; role: "user" | "assistant"; content: string; sentAt: string; citations?: ChatCitation[]; interactionId?: string; rating?: "GOOD" | "BAD"; answerType?: "FAQ" | "GENERATED_AI" | "NO_ANSWER" };
