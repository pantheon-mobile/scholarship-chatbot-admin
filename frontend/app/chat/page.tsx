...
export default function ChatPage() {
  ...
  const [bedrockSessionId, setBedrockSessionId] = useState<string>(); const chatSessionId = useRef(crypto.randomUUID()); const chatStarted = useRef(false); const endRef = useRef<HTMLDivElement>(null); const composingQuestion = useRef(false);
